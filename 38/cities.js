// Q: Cities: Write a function called describe_city() that accepts the name of a city and its country.
...
function describe_city(city, country) {
    ...
    // country = "Pakistan";
    console.log("Hey! ".concat(city, " is in ").concat(country));
}
describe_city("Karachi", "Pakistan");
describe_city("Islamabad");
describe_city("chicago", "Canada");
